...
from pyrogram.errors import FloodWait, ApiIdInvalid, AccessTokenInvalid, PhoneCodeInvalid, PhoneCodeExpired, SessionPasswordNeeded
import re
import json
...
Попробуйте снова или отправьте /cancel для отмены.
            ...
            phone_text = f"""
{Emoji.LOCK} *API Hash сохранен:* `{api_hash[:5]}...{api_hash[-5:]}`
