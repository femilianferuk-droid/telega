...
API_ID = os.getenv("API_ID")  # Опционально, можно оставить для ручного ввода
API_HASH = os.getenv("API_HASH")  # Опционально
...
async def main():
    ...
    bot = Client(
        ...
        api_hash="eb06d4abfb49dc3eeb1aeb98ae0f581e"  # Стандартный API Hash для ботов
    )
